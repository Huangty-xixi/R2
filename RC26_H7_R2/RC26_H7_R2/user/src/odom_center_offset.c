...
static const float s_blue_dx_m[4] = {-0.09f, 0.09f, 0.11f, -0.11f};
static const float s_blue_dy_m[4] = {0.11f, -0.11f, 0.09f, -0.09f};

/* 红区：与旧红区旋转关系在 FRONT/BACK/LEFT/RIGHT 四向一致 */
static const float s_red_dx_m[4] = {0.09f, -0.09f, -0.11f, 0.11f};
static const float s_red_dy_m[4] = {0.11f, -0.11f, 0.09f, -0.09f};
