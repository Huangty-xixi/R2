...
void MX_UART9_Init(void)
{
  ...
  huart9.Init.StopBits = UART_STOPBITS_2;
  ...
  huart9.AdvancedInit.AdvFeatureInit = UART_ADVFEATURE_RXINVERT_INIT;
  huart9.AdvancedInit.RxPinLevelInvert = UART_ADVFEATURE_RXINV_ENABLE;
...
void MX_USART10_UART_Init(void)
{
  ...
  huart10.Init.Mode = UART_MODE_RX;
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    */
    ...
    /* UART9 DMA Init */
    /* UART9_RX Init */
    hdma_uart9_rx.Instance = DMA1_Stream2;
